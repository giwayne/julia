...
@testset "Cwstring" begin
    ...
    if Sys.iswindows()
        ...
        len = @ccall swprintf_s(buffer::Ptr{Cwchar_t}, n::Csize_t, "α+%s=%hhd"::Cwstring; "β"::Cwstring, 0xf::UInt8)::Cint
    else
        len = @ccall swprintf(buffer::Ptr{Cwchar_t}, n::Csize_t, "α+%s=%hhd"::Cwstring; "β"::Cwstring, 0xf::UInt8)::Cint
    end
